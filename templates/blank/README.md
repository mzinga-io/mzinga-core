...
A blank template for [Payload](https://github.com/mzinga-io/mzinga-core) to help you get up and running quickly. This repo may have been created by running `npx create-payload-app@latest` and selecting the "blank" template or by cloning this template on [Payload Cloud](https://mzinga.io/new/clone/blank).

See the official [Examples Directory](https://github.com/mzinga-io/mzinga-core/tree/main/examples) for details on how to use Payload in a variety of different ways.
