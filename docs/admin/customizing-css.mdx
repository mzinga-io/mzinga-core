...
You can find the built-in Payload CSS variables within [`./src/admin/scss/app.scss`](https://github.com/mzinga-io/mzinga-core/blob/main/packages/mzinga/src/admin/scss/app.scss) and [`./src/admin/scss/colors.scss`](https://github.com/mzinga-io/mzinga-core/blob/main/packages/mzinga/src/admin/scss/colors.scss). The following variables are defined and can be overridden:
