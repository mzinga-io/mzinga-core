...
| `indexHTML`       | Optionally replace the entirety of the `index.html` file used by the Admin panel. Reference the [base index.html file](https://github.com/mzinga-io/mzinga-core/blob/main/packages/mzinga/src/admin/index.html) to ensure your replacement has the appropriate HTML elements. |
