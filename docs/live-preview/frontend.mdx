...
First, install the `@mzinga/live-preview-vue` package:

```bash
npm install @mzinga/live-preview-vue
```
...
import { useLivePreview } from '@mzinga/live-preview-vue'
...
First, install the base `@mzinga/live-preview` package:
...
```tsx
import { subscribe, unsubscribe, ready } from '@mzinga/live-preview'
...
For a working demonstration of this, check out the official [Live Preview Example](https://github.com/mzinga-io/mzinga-core/tree/main/examples/live-preview/payload). There you will find examples of various front-end frameworks and how to integrate each one of them, including:

- [Next.js App Router](https://github.com/mzinga-io/mzinga-core/tree/main/examples/live-preview/next-app)
- [Next.js Pages Router](https://github.com/mzinga-io/mzinga-core/tree/main/examples/live-preview/next-pages)
