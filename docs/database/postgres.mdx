...
To use Payload with Postgres, install the package `@mzinga/db-postgres`. It leverages Drizzle ORM and `node-postgres` to interact with a Postgres database that you provide.
