...
<Banner type="info">
  ...
  here](https://github.com/mzinga-io/mzinga-core/tree/main/packages/plugin-nested-docs). If you need
  help, check out our [Community Help](https://payloadcms.com/community-help). If you think you've
  found a bug, please [open a new
  issue](https://github.com/mzinga-io/mzinga-core/issues/new?assignees=&labels=plugin%3A%20nested-docs&template=bug_report.md&title=plugin-nested-docs%3A)
...
import { createParentField } from '@mzinga/plugin-nested-docs/fields'
import { createBreadcrumbsField } from '@mzinga/plugin-nested-docs/fields'
...
```ts
import { PluginConfig, GenerateURL, GenerateLabel } from '@mzinga/plugin-nested-docs/types'
```

## Examples

The [Examples Directory](https://github.com/mzinga-io/mzinga-core/tree/main/examples) contains an
official [Nested Docs Plugin Example](https://github.com/mzinga-io/mzinga-core/tree/main/examples/nested-docs) which
demonstrates exactly how to configure this plugin in Payload and implement it on your front-end.
The [Templates Directory](https://github.com/mzinga-io/mzinga-core/tree/main/templates) also contains an
official [Website Template](https://github.com/mzinga-io/mzinga-core/tree/main/templates/website)
and [E-commerce Template](https://github.com/mzinga-io/mzinga-core/tree/main/templates/ecommerce), both of which use this
plugin.
