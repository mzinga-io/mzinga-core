...
<Banner type="info">
  ...
  here](https://github.com/mzinga-io/mzinga-core/tree/main/packages/plugin-sentry). If you need
...
import { sentry } from '@mzinga/plugin-sentry'
...
<Banner type="warning">
  You can find your project DSN (Data Source Name) by visiting [sentry.io](sentry.io) and navigating
  to your [Project] > Settings > Client Keys (DSN).
</Banner>
...
```ts
import { PluginOptions } from '@mzinga/plugin-sentry/types'
```
