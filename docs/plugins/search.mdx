...
<Banner type="info">
  ...
  here](https://github.com/mzinga-io/mzinga-core/tree/main/packages/plugin-search). If you need
  help, check out our [Community Help](https://payloadcms.com/community-help). If you think you've
  found a bug, please [open a new
  issue](https://github.com/mzinga-io/mzinga-core/issues/new?assignees=&labels=plugin%3A%20search&template=bug_report.md&title=plugin-search%3A)
...
import search from '@mzinga/plugin-search'
...
```ts
import type { SearchConfig, BeforeSync } from '@mzinga/plugin-search/types'
```
