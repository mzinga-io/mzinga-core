...
<Banner type="success">
  To use the template, run `npx create-mzinga-app@latest -t plugin -n my-new-plugin` directly in
  your terminal or [clone the template directly from
  GitHub](https://github.com/mzinga-io/mzinga-core-plugin-template).
</Banner>
...
In the [Payload plugin template](https://github.com/mzinga-io/mzinga-core-plugin-template), you will see a common file structure that is used across plugins:
