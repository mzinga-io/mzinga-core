...
This is a [Next.js](https://nextjs.org) app using the [App Router](https://nextjs.org/docs/app). It was made explicitly for Payload's [Nested Docs Example](https://github.com/mzinga-io/mzinga-core/tree/main/examples/nested-docs/payload).

> This example uses the App Router, the latest API of Next.js. If your app is using the legacy [Pages Router](https://nextjs.org/docs/pages), check out the official [Pages Router Example](https://github.com/mzinga-io/mzinga-core/tree/main/examples/nested-docs/next-pages).
...
Once running you will find a couple seeded pages on your local environment with some basic instructions. You can also start editing the pages by modifying the documents within Payload. See the [Nested Docs Example](https://github.com/mzinga-io/mzinga-core/tree/main/examples/nested-docs/payload) for full details.
